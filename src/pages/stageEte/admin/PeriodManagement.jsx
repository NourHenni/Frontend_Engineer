...
function PeriodManagement() {
  ...
  const handleAddSave = async () => {
    try {
      ...
      if (
        !addFormData.DateDebutDepot ||
        !addFormData.DateFinDepot ||
        !addFormData.niveau
      ) {
      ...
      message.error(
        err.response?.data?.message || "Erreur lors de l'ajout de la période"
      );
    }
  };
    ...
    <div className="layout">
      ...
      <div className="main-layout">
        ...
        <div className="content">
          ...
          <Modal
            title={
              <span style={{ fontSize: 20 }}>Ajouter une nouvelle période</span>
            }
            ...
            <Form layout="vertical">
              <Form.Item label="Niveau" required>
                <Select
                  ...
                  onChange={(value) =>
                    setAddFormData({ ...addFormData, niveau: value })
                  }
                  size="large"
                >
              ...
              <Form.Item label="Date début dépôt" required>
                <DatePicker
                  ...
                  onChange={(date) =>
                    setAddFormData({ ...addFormData, DateDebutDepot: date })
                  }
                  style={{ width: "100%" }}
                  format="DD/MM/YYYY"
                  size="large"
              ...
              <Form.Item label="Date fin dépôt" required>
                <DatePicker
                  ...
                  onChange={(date) =>
                    setAddFormData({ ...addFormData, DateFinDepot: date })
                  }
                  style={{ width: "100%" }}
                  format="DD/MM/YYYY"
                  size="large"
            ...
            <Form layout="vertical">
              <Form.Item label="Date début dépôt" required>
                <DatePicker
                  ...
                  onChange={(date) =>
                    setFormData({ ...formData, DateDebutDepot: date })
                  }
                  style={{ width: "100%" }}
                  format="DD/MM/YYYY"
                  size="large"
              ...
              <Form.Item label="Date fin dépôt" required>
                <DatePicker
                  ...
                  onChange={(date) =>
                    setFormData({ ...formData, DateFinDepot: date })
                  }
                  style={{ width: "100%" }}
                  format="DD/MM/YYYY"
                  size="large"
