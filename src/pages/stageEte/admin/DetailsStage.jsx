          ...
          >
            <Descriptions column={1} size="middle" className="stage-info">
              ...
              {stageDetails.stage.adresseEntreprise && (
                <Descriptions.Item
                  label={<Text strong>Adresse Entreprise :</Text>}
                >
                  {stageDetails.stage.adresseEntreprise}
                </Descriptions.Item>
              )}
              ...
              <Descriptions.Item label={<Text strong>Période de stage :</Text>}>
                Du {new Date(stageDetails.stage.dateDebut).toLocaleDateString()}{" "}
                au {new Date(stageDetails.stage.dateFin).toLocaleDateString()}
              </Descriptions.Item>
