...
// Ant Design
import {
  Button, Col, DatePicker, Descriptions, Card, message,
  Form, Input, Modal, Row, Spin,
  Space, Tag, TimePicker, Typography, Radio,
} from "antd";
    ...
    <div className="stage-details-container">
      ...
      <div className="header">
        ...
        <Title level={2} className="main-title">
          Détails du Stage - {type === "premiereannee" ? "1ère Année" : "2ème Année"}
        </Title>
      </div>
          ...
          <Card title="Détails du Stage" className="info-card stage-card">
            <Descriptions column={1} size="small">
              <Descriptions.Item label={<Text strong>Titre</Text>}>
                <Text className="stage-title">{stageDetails.stage.titreSujet}</Text>
              </Descriptions.Item>
              ...
              <Descriptions.Item label={<Text strong>Période</Text>}>
                <CalendarOutlined /> Du {new Date(stageDetails.stage.dateDebut).toLocaleDateString()} au{" "}
              ...
              <Descriptions.Item label={<Text strong>Statut</Text>}>
                <Space>
                  ...
                  <Tag color={stageDetails.stage.statutDepot === "Depose" ? "success" : "warning"}>
              ...
              <Descriptions.Item label={<Text strong>Documents</Text>}>
                <Space direction="vertical">
                  {renderFileButton(stageDetails.stage.fichiers.rapport, "Rapport")}
                  {renderFileButton(stageDetails.stage.fichiers.attestation, "Attestation")}
      ...
      >
        <Form form={form} layout="vertical">
          ...
          <Form.Item
            ...
            name="lien"
            rules={[
              { required: true, message: "Veuillez saisir le lien Google Meet." },
              {
      ...
      >
        <Form layout="vertical" form={form}>
          ...
          <Form.Item
            ...
            label="Heure"
            rules={[
              { required: true, message: "Veuillez choisir une heure" },
            ]}
          >
            <TimePicker format="HH:mm" style={{ width: "100%" }} />
          </Form.Item>
