...
import {
    ...
    UnorderedListOutlined, LockOutlined
                                ...
                                <Row gutter={[30, 30]}>
                                            ...
                                            <Space direction="vertical" style={{ width: "100%" }}>
                                                ...
                                                {editMode ? (
                                                    ...
                                                    <Descriptions column={1} labelStyle={{ fontWeight: 600, color: "#555" }}>
                                                        <Descriptions.Item label="CIN">{renderField(teacher.cin)}</Descriptions.Item>
                                                        <Descriptions.Item label="Gender">{renderField(teacher.genre)}</Descriptions.Item>
                                                        <Descriptions.Item label="Date of Birth">
                                                            {renderField(new Date(teacher.dateDeNaissance).toLocaleDateString())}
                                                        </Descriptions.Item>
                                        ...
                                        <Card title="Contact Information" bordered={false} style={{ ...cardStyle, marginTop: "20px" }}>
                                            <Space direction="vertical" style={{ width: "100%" }}>
                                                {editMode ? (
                                                    ...
                                                    <>
                                                        <Text><PhoneOutlined style={{ color: "#1890ff" }} /> {renderField(teacher.telephone)}</Text>
                                                        <Text><MailOutlined style={{ color: "#1890ff" }} /> {renderField(teacher.adresseEmail)}</Text>
                                                        <Text><HomeOutlined style={{ color: "#1890ff" }} /> {renderField(teacher.addresse)}</Text>
                                                    </>
                                                )}
                                            </Space>
                                        </Card>
                                    ...
                                    <Col span={12}>
                                        <Card title="Additional Information" bordered={false} style={{ ...cardStyle, marginTop: "20px" }}>
                                            <Space direction="vertical" style={{ width: "100%" }}>
                                                <Text><UnorderedListOutlined style={{ color: "#1890ff" }} /> {renderField(teacher.role)}</Text>
                                                <Text><UnorderedListOutlined style={{ color: "#1890ff" }} /> {renderField(teacher.grade)}</Text>
                                            </Space>
                                        </Card>
                                    </Col>
                                </Row>
